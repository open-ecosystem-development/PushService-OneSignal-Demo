...
2. Create Huawei developer account, if you don't have [from here](https://developer.huawei.com/consumer/en/). 
   Create project and app in  
4. Develop Android app and add app details in Huawei App Gallery Connect by creating an app.
5. Enable Huawei Push kit in your app from Huawei App Gallery Connect. Add Huawei configuration - agconnect-services.json file in your Android Studio project.
